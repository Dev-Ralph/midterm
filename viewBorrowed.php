<?php
require_once $_SERVER['DOCUMENT_ROOT'].'/midterm/resource/php/function/delete.php';
...
<div class="container">
 <?php
 require_once $_SERVER['DOCUMENT_ROOT'].'/midterm/resource/php/function/viewDataBorrowed.php';
 session_start();
 ...
 if (isset($_GET['username'])) {
   $view = new viewDataBorrowed($_SESSION['username'], $_SESSION['id']);
   $view->viewAllData();
 }
 ?>
</div>
